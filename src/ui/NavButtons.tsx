    ...
    return (
        ...
        >
            ...
            <div className={`absolute inset-0 rounded-xl blur-md transition-all duration-300 ${
                isActive 
                    ? 'bg-gradient-to-br from-violet-400/40 via-violet-500/30 to-purple-600/40 scale-110' 
                    : 'bg-gradient-to-br from-violet-400/20 via-violet-400/15 to-purple-500/20 group-hover:scale-105 group-hover:from-violet-400/25 group-hover:via-violet-500/20 group-hover:to-purple-600/25'
            }`} />
            ...
            <div 
                ...
                ${isActive 
                    ...
                    : 'bg-gradient-to-br from-black/15 via-black/20 to-black/25 border-black/20 group-hover:border-violet-400/30 group-hover:from-black/20 group-hover:via-black/25 group-hover:to-black/30 [transform:rotateX(5deg)_rotateY(-5deg)] [transform-style:preserve-3d] shadow-[0_4px_16px_rgba(0,0,0,0.2),_inset_0_1px_0_rgba(255,255,255,0.05)]'
                }`}
            >
                {/* Top highlight */}
                <div className={`absolute top-2 left-2 right-2 h-8 rounded-lg transition-all duration-300 ${
                    isActive 
                        ? 'bg-gradient-to-r from-white/30 via-violet-400/20 to-white/25 [translateZ:2px]' 
                        : 'bg-gradient-to-r from-white/20 via-white/15 to-white/10 group-hover:from-white/25 group-hover:via-white/20 group-hover:to-white/15 [translateZ:2px]'
                }`} />
                ...
                {/* Logo container */}
                <div className={`relative z-10 flex justify-center items-center w-8 h-8 mb-1 rounded-lg transition-all duration-300 ${
                    isActive 
                ...
                {/* Text */}
                <div className={`flex justify-center items-center text-center text-xs z-10 font-medium transition-all duration-300 ${
                    isActive 
