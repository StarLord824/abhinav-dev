...
export default function NavButton({
  ...
  return (
    ...
    >
      {/* Ambient glow effect */}
      <div
        className={`absolute inset-0 rounded-xl blur-md transition-all duration-300 bg-gradient-to-br from-violet-400/20 via-violet-400/15 to-purple-500/20 group-hover:scale-105 group-hover:from-violet-400/25 group-hover:via-violet-500/20 group-hover:to-purple-600/25`}
      />
